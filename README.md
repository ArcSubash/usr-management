...
NOTE:   Due to some technical issues at the last minute, currently the OTP is not sending while registering. so use the Test User Credentials to login as a user
